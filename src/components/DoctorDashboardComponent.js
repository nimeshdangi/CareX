...
import DoctorDashboardTopbar from "./DoctorDashboardTopbar";
                        ...
                        <tbody>
                            {
                                appointmentsToday?.length > 0 ? (appointmentsToday.map((appointment) => {
                                    ...
                                    return (
                                        <tr key={appointmentsToday.id} className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
