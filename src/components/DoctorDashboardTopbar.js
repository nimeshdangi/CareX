const DoctorDashboardTopbar = ({ title }) => {
    return (
        <div className={`bg-gradient-to-r from-[#B5D2F0] to-[#FCF7E1] flex items-center justify-between px-6 py-4`}>
            <h1 className="text-2xl font-bold text-gray">{title || "Dashboard"}</h1>
...
export default DoctorDashboardTopbar;