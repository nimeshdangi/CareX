                                    ...
                                    <td className="px-6 py-4">
                                        {appointment.status === "Completed" ? (
                                            <span className="font-medium text-blue-600 dark:text-blue-500">
                                                {appointment?.status == "Completed" ? (
                                                <div onClick={() => router.push(`/appointments/${appointment.id}`)} className="font-medium bg-blue-100 py-2 rounded-md text-center text-blue-600 dark:text-blue-500 hover:bg-blue-200">View Appointment Detials</div>) : appointment?.status}
