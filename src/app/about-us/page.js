    ...
    return (
        <SideBar>
            ...
            <div className="container mx-auto px-6 py-4">
                ...
                <p className="text-center">Connecting Patients with Healthcare Professionals Seamlessly</p>
            </div>
            <div className="container mx-auto px-32 py-4">
                <h1 className="text-3xl text-center">Our Mission</h1>
                <Image
                    src="/mission.svg"
                    alt="mission"
                    width={1000}
            ...
            <div className="container mx-auto px-16 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mt-2">
                    <div className="flex flex-col items-center justify-center bg-blue-100 rounded-xl px-4 py-6">
            ...
            <div className="container mx-auto px-16 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mt-2">
                    <div className="flex flex-col items-center justify-center bg-slate-100 rounded-xl px-4 py-6">
            ...
            <div className="container mx-auto px-16 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 mt-2">
                    <div className="flex flex-col items-center justify-center bg-gray-100 rounded-xl px-4 py-6">
            ...
            <div className="container mx-auto px-16 py-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 mt-2">
                    <div className="bg-neutral-200 rounded-xl px-7 pb-3 pt-5">
                    ...
                    <div className="bg-neutral-200 rounded-xl px-7 pb-3 pt-5">
                        ...
                        <p className="text-right flex items-center justify-end space-x-4">
                            <span>— Dr. Michael Anderson, Licensed Therapist</span>
                            <Image
                                src="/doctor.jpg"
                                width={100}
                                height={100}
